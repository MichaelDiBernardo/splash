...
RawImageOpen(const char *fileName)
{
   ...
   if ((raw->file = fopen(fileName, "rb")) == NULL) {
     perror(fileName);
     /* GGS 4/20/99: should //free allocate memory for raw if we can't 
open the file */
     //free (raw);
     raw = NULL;
     return NULL;
   ...
   if (raw->tmp == NULL) {
     fprintf(stderr, "Out of memory!\n");
     /* GGS 4/20/99: should //free allocate memory for raw->tmp and raw 
if we can't open the file */
   ...
   if (raw->tmpR == NULL) {
     fprintf(stderr, "Out of memory!\n");
      /* GGS 4/20/99: should //free allocate memory for raw->tmpR, 
raw->tmp and raw if we can't open the file */
     //free (raw->tmpR);
     //free (raw->tmp);
     //free (raw);
     raw = NULL;
